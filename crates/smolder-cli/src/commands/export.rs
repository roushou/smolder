...
fn export_json(deployments: &[smolder_core::DeploymentView]) -> Result<String> {
...
fn export_typescript(deployments: &[smolder_core::DeploymentView]) -> Result<String> {
    let mut output = String::new();
    output.push_str("// Auto-generated by smolder export\n\n");
    output.push_str("export const contracts = {\n");

    // Group by network
    let mut networks: HashMap<String, Vec<&smolder_core::DeploymentView>> = HashMap::new();
    for d in deployments {
...
fn export_env(deployments: &[smolder_core::DeploymentView]) -> Result<String> {
    let mut output = String::new();
    output.push_str("# Auto-generated by smolder export\n\n");
